...
> [cronograma](../cronograma.md) · Todos.

---

## 3.1 Natureza e tipo de pesquisa

<!-- As diretrizes institucionais (../diretrizes.md) listam os tipos possíveis.
...
<!-- As quatro regras e seus pesos, conforme ../arquitetura.md.
...
<!-- Os seis cenários de ../arquitetura.md, com o score esperado de cada um.
...
<!-- Método já definido e com fontes em ../usabilidade.md, seção 6: avaliação
...
<!-- Taxa de detecção (recall), taxa de falsos positivos e MTTD, com as fórmulas
     de ../arquitetura.md. Diga como cada número será obtido. -->

---

## O que esta seção ainda precisa

- [ ] Natureza da pesquisa declarada conforme `../diretrizes.md`
- [ ] Justificativa dos pesos das regras, não só a apresentação
- [ ] Declaração explícita de que não há dado de pessoa real
- [ ] Fórmulas conferidas contra `../arquitetura.md`
