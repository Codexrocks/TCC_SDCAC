...
**Por que existe:** ninguém perde o fio da meada entre uma semana e outra, e a banca tem prova documentada de como o projeto foi construído.
...
Use o [modelo](_modelo.md) e adicione a página nova ao [`docs/SUMMARY.md`](https://github.com/Codexrocks/TCC_SDCAC/tree/gitbook/docs/documentacao/docs/SUMMARY.md).
